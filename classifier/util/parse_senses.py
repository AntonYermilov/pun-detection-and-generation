...
def parse_ruwordnet(src_senses, src_synsets):
...
def parse():
    parse_ruwordnet('ruwordnet/senses.A.xml', 'ruwordnet/synsets.A.xml')
    parse_ruwordnet('ruwordnet/senses.N.xml', 'ruwordnet/synsets.N.xml')
    parse_ruwordnet('ruwordnet/senses.V.xml', 'ruwordnet/synsets.V.xml')
